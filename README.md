...
npm install
```
5. Pronto! Agora basta iniciar ambos os projetos com o comando:
```
npm run start
```
6. Depois que tudo estiver iniciado, você poderá acessar a aplicação pelo link [http://localhost:3000/](http://localhost:3000/)
